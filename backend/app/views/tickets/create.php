<div class="max-w-2xl mx-auto bg-white rounded-xl shadow-sm border border-slate-100 p-6">
  ...
  <form method="post" action="<?= url('/tickets') ?>" enctype="multipart/form-data" class="space-y-4"><?= csrf_field() ?>
    ...
    <div class="flex justify-end gap-2">
      <a href="<?= url('/tickets') ?>" class="px-4 py-2 rounded border border-slate-300">Cancel</a>
