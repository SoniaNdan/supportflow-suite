<div class="max-w-md mx-auto mt-12 bg-white rounded-xl shadow p-8">
  ...
  <form method="post" action="/login" class="space-y-4"><?= csrf_field() ?>
  ...
  <p class="text-sm mt-4 text-slate-500">No account? <a href="/register" class="text-indigo-600">Register</a> · <a href="/forgot-password" class="text-indigo-600">Forgot password?</a></p>
</div>
<?php clear_old(); ?>
