<div class="max-w-md mx-auto mt-12 bg-white rounded-xl shadow p-8">
  ...
  <p class="text-sm text-slate-500 mb-4">Enter your email and we'll generate a reset link.</p>
  <form method="post" action="/forgot-password" class="space-y-4"><?= csrf_field() ?>
